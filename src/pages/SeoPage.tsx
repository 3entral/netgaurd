          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-4 mb-8">
                ...
                <Link to="/seo-audit" className="bg-[#111c2d] hover:bg-[#1a2942] px-6 py-3 rounded-lg transition-colors flex items-center gap-2">
                  Free SEO Audit <Search className="w-5 h-5" />
                </Link>
              </div>
